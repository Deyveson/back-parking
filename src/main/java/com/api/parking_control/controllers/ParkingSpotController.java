...
public class ParkingSpotController {
    ...
    @PostMapping
    @Operation(summary = "Cadastra uma nova vaga de estacionamento")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Vaga cadastrada com sucesso"),
            @ApiResponse(responseCode = "409", description = "Conflito - Placa, número ou apartamento/bloco já em uso")
    })
